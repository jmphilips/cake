...
def matching_times(flight_length, movie_time_array)
  movie_time_array.map do |time|
    holder_array = movie_time_array
    holder_array.delete(time)
    holder_array.include?(flight_length - time)
  end.include?(true)
end